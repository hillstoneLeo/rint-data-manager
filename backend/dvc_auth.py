...
def verify_database_auth(authorization: Optional[str], db: Session, auth_config: Dict[str, Any]) -> User:
...
def verify_basic_auth(authorization: Optional[str], auth_config: Dict[str, Any]) -> bool:
...
def verify_custom_auth(x_dvc_token: Optional[str], auth_config: Dict[str, Any]) -> bool:
